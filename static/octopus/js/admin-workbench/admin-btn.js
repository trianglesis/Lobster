...
function assignAdminButtons() {
    ...
    p4_info.addEventListener('click', buttonActivation);

    // p4_sync.dataset.operation_key = 'p4_sync';
    p4_sync.addEventListener('click', buttonActivation);

    // p4_sync_force.dataset.operation_key = 'p4_sync_force';
    p4_sync_force.addEventListener('click', buttonActivation);

    // parse_full.dataset.operation_key = 'parse_full';
    parse_full.addEventListener('click', buttonActivation);

    // cases_weight.dataset.operation_key = 'cases_weight';
    cases_weight.addEventListener('click', buttonActivation);
