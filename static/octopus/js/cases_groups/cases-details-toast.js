/**
 * Test Cases Table and Page Toast
 *
 * This is an event listener and toast maker for pattern test cases on page: /octo_tku_patterns/test_cases/
...
function testRunPrepareToast(testButtonDataset) {
    ...
    let caseData = parseModalVariables(modalBody);  // parse modal body
